...
def get_lr_multiplier(progress):
    if progress < WARMUP_RATIO:
        ...
        # Inverse square root schedule: 1/sqrt(1 + step_fraction)
        step_fraction = (progress - WARMUP_RATIO) / (1.0 - WARMUP_RATIO) if WARMUP_RATIO < 1.0 else 0.0
        return 1.0 / (1.0 + step_fraction)**0.5
