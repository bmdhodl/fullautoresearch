...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=resid_params, lr=scalar_lr * 0.1, betas=adam_betas, eps=1e-8, weight_decay=0.001),
            dict(kind='adamw', params=x0_params, lr=scalar_lr * 6.0, betas=(0.8, 0.95), eps=1e-6, weight_decay=0.0),
        ]
