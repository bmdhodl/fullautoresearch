...
UNEMBEDDING_LR = 0.010  # learning rate for lm_head (Adam) - tuned for small batch
# UNEMBEDDING_LR defined above
MATRIX_LR = 0.035       # learning rate for matrix parameters (Muon)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.2      # cautious weight decay for Muon
ADAM_BETAS = (0.8, 0.95) # Adam beta1, beta2
WARMUP_RATIO = 0.0      # fraction of time budget for LR warmup
WARMDOWN_RATIO = 0.46  # fraction of time budget for LR warmdown
