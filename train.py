...
grad_accum_steps = 1  # Force 1 for 2x more optimizer steps in fixed time budget
...
def get_lr_multiplier(progress):
    ...
    return FINAL_LR_FRAC + 0.5 * (1.0 - FINAL_LR_FRAC) * (1 + math.cos(math.pi * cosine_progress))
