...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        # Separate Q/K projections from V projections for different weight decay
        qk_params = []
        v_params = []
        other_matrix_params = []
        for block in self.transformer.h:
        ...
        assert len(list(self.parameters())) == (len(qk_params) + len(v_params) + len(other_matrix_params) + len(embedding_params) +
        ...
        # Q/K projections with lower weight decay
        ...
        # V projections with higher weight decay
        ...
        # Other matrix parameters with normal weight decay
