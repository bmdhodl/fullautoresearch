...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=resid_params, lr=scalar_lr * 0.05, betas=adam_betas, eps=1e-10, weight_decay=0.001),
...
def get_lr_multiplier(progress):
    if progress < WARMUP_RATIO:
        ...
        # Cosine warmdown: keeps LR higher for longer before final drop
        cosine_factor = 0.5 * (1 + math.cos(math.pi * (1 - cooldown)))
        return cosine_factor * 1.0 + (1 - cosine_factor) * FINAL_LR_FRAC
